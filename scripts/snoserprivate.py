...
if a != "eternal":
    print(colored("Пароль не верен! Завершаю работу программы!", 'red'))
    print(colored("Уточни его у создателей", 'red'))
    sys.exit()
else:
    print(colored("Пароль верен! Запускаю работу программы!", 'green'))
...
╔================================================╗
║ [1] СНОСUНГ АКК0В      [2] СНОСUНГ КАНАЛ0В     ║
║                                                ║
║ [3] СНОСUНГ Б0Т0В      [4] СНОСUНГ ЧАТОВ       ║
╚================================================╝
'''
